Algoritmo moneda
	...
	Si MON_F es "GBP" y MON_D es "USD" Entonces
		...
		Escribir "El valor de " MON_D " es: " RESULTADO 
	FinSi
	Si MON_F es "GBP" y MON_D es "EUR" Entonces
		RESULTADO <- MON_C * 1.18
		Escribir "El valor de " MON_D " es: " RESULTADO 
	FinSi
	Si MON_F es "GBP" y MON_D es "AUD" Entonces
		RESULTADO <- MON_C * 1.90
		Escribir "El valor de " MON_D " es: " RESULTADO 
	FinSi
	Si MON_F es "AUD" y MON_D es "USD" Entonces
		RESULTADO <- MON_C * 0.67
		Escribir "El valor de " MON_D " es: " RESULTADO 
	FinSi
FinAlgoritmo
